-- ============================================================
-- EduLink — Combined Migration for Personal Supabase Project
...
-- (Migration 2 replaces this policy — using the updated version directly)
...
create policy "Authenticated users upload their own avatar"
